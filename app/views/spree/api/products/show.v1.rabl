...
attributes :product_category, :product_subcategory, :specs, :tagline, :color_type_ids, :option_type_ids, :property_ids, :featured, :master_variant_id, :shipping_category_id, :in_catalogue, :in_custom_shop
