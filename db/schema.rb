...
ActiveRecord::Schema.define(version: 20160525030244) do
  ...
  create_table "spree_color_type_color_values", force: :cascade do |t|
    t.integer  "position"
  ...
  create_table "spree_color_types", force: :cascade do |t|
    ...
    t.boolean  "line_color",               default: false
  end

  create_table "spree_color_values", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string   "color_image_file_name",    limit: 255
    t.string   "color_image_content_type", limit: 255
    t.integer  "color_image_file_size"
    t.datetime "color_image_updated_at"
    t.integer  "position"
  end

  create_table "spree_color_values_variants", id: false, force: :cascade do |t|
    t.integer "variant_id"
    t.integer "color_value_id"
  end

  add_index "spree_color_values_variants", ["variant_id", "color_value_id"], name: "index_color_values_variants_on_variant_id_and_color_value_id", using: :btree
  add_index "spree_color_values_variants", ["variant_id"], name: "index_spree_color_values_variants_on_variant_id", using: :btree
  ...
  create_table "spree_line_item_color_types", force: :cascade do |t|
    t.integer  "color_type_id"
    t.integer  "line_item_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "spree_line_item_option_values", force: :cascade do |t|
  ...
  create_table "spree_line_items", force: :cascade do |t|
    ...
    t.string   "custom_item_hash",     limit: 255
  ...
  create_table "spree_option_types", force: :cascade do |t|
    ...
    t.boolean  "required"
    t.boolean  "catalogue"
    t.string   "option_type_image_file_name",    limit: 255
    t.string   "option_type_image_content_type", limit: 255
    t.integer  "option_type_image_file_size"
    t.datetime "option_type_image_updated_at"
  end
  ...
  create_table "spree_option_values", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string   "option_image_file_name",    limit: 255
    t.string   "option_image_content_type", limit: 255
  ...
  create_table "spree_product_color_types", force: :cascade do |t|
    t.integer  "position"
  ...
  create_table "spree_product_mocks", force: :cascade do |t|
    t.string   "name",                          limit: 255
    t.string   "presentation",                  limit: 255
    t.integer  "position",                                  default: 0, null: false
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "product_id"
    t.string   "product_mock_svg_file_name",    limit: 255
    t.string   "product_mock_svg_content_type", limit: 255
  ...
  add_index "spree_products", ["product_category"], name: "index_spree_products_on_product_category", using: :btree
  add_index "spree_products", ["product_subcategory"], name: "index_spree_products_on_product_subcategory", using: :btree
  ...
  create_table "spree_variant_colors", force: :cascade do |t|
    t.integer "variant_id"
    t.integer "color_type_id"
    t.integer "color_value_id"
  end
  ...
  create_table "spree_variants", force: :cascade do |t|
    ...
    t.string   "instock_description", limit: 255,                          default: ""
    t.string   "instock_name",        limit: 255,                          default: ""
